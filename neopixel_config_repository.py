    ...
    def create(self):
        ...
        try:
            with sqlite3.connect(self.database_name) as connection:
                ...
                cursor.execute("""ALTER TABLE IF EXISTS NeopixelConfig RENAME COLUMN lightId TO uuid;""")
                cursor.execute("""ALTER TABLE IF EXISTS NeopixelConfig RENAME TO configs;""")
                cursor.execute(
